...
class BubblePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final bubblePath = Path()
      ..moveTo(sideX * 2, 0)
      ..arcTo(Offset(0, 0) & Size(sideX * 4, sideY * 2), -1.5, -3, false)
      ..lineTo(sideX * 2, bubbleSize.height)
      ..arcTo(Offset(sideX * 4, 0) & Size(sideX * 4, sideY * 2), 1.5, -3, false)
      ..lineTo(sideX * 2, 0);

    final tailPath = Path()
      ..moveTo(bubbleSize.width / 2 - 25, bubbleSize.height - 10)
      ..lineTo(bubbleSize.width / 2, bubbleSize.height + 20)
      ..lineTo(bubbleSize.width / 2 + 25, bubbleSize.height - 10);

    final inPath = Path()
      ..moveTo(bubbleSize.width / 2 - 18, bubbleSize.height - 5)
      ..lineTo(bubbleSize.width / 2, bubbleSize.height + 15)
      ..lineTo(bubbleSize.width / 2 + 18, bubbleSize.height - 5);
